      ...
      <div class="content content--side">
        <header class="codrops-header uk-flex uk-flex-center">
          <h1 class="uk-margin-remove uk-text-center">
            Bem-Vindo {{ $store.getters.appName }}
          </h1>
          <p class="">Preencha o formulário parar se registrar!</p>
        </header>
        <div class="form">
          ...
          >
            ...
            <span class="uk-margin-left">
              <small
                >Recomendamos fortemente que você use uma senha segura. Melhor
                conselho: quando você pode ver a imagem nítida, então a senha é
                boa!</small
              >
            </span>
          </div>
          <div class="form__item form__item--actions">
            <span
              ...
              <router-link class="form__link" to="/login">Login</router-link>
            </span>
            <button-spinner ref="loadingButton" @click="register()"
              >Registrar</button-spinner
            >
          </div>
        </div>
      </div>
